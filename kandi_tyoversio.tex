...
TODO mahdollisesti listaus Penn Treebank-sanaluokkasetistä, esimerkkipätkä harjoitusaineistosta.
...
Markovin piilomallit hyödyntävät sitä seikkaa, että yhteisjakauma $P(x,y)$ voidaan jakaa osiin $P(y)P(x|y)$. Tällöin edellämainittu funktio $ p $ \eqref{generativemodel} voidaan kuvata muodossa
