...
Yksi Brillin tunnistimen puutteista on se, että sen tulosten varmuus ei ole suoraan määritettävissä. Tilastollisten tunnistimien tuloksiin liittyy aina jonkinlainen todennäköisyysarvo, jonka perusteella tunnistamisen onnistumista voidaan arvioida; Brillin tunnistin taas asettaa jokaiselle sanalle aina yhden sanaluokan ottamatta kantaa todennäköisyyksiin. Todennäköisyysarvot ovat hyödyllisiä monin eri tavoin: esimerkiksi jos tunnistin ei pysty käsittelemään jotakin aineiston osaa tarpeeksi suurella varmuudella, voidaan yrittää samaa erilaisilla tunnistimilla ja käyttää sitä arvoa, jolla on suurin todennäköisyys. Brillin tunnistin ei --- ilman muokkauksia --- pysty toimimaan osana tällaista järjestelmää. 
